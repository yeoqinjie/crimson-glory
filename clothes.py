...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        self.radio_male = tk.Radiobutton(self, text='Male', variable=self.gender, value=1)
        self.radio_female = tk.Radiobutton(self, text='Female', variable=self.gender, value=2)
